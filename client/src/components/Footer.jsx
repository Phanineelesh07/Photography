      ...
      <div className="footer-bottom">
        <div className="container bottom-content" style={{ justifyContent: 'center' }}>
          <div className="copyright">
            &copy; Copyright {new Date().getFullYear()} - Film and photography club - Aditya University . All Rights Reserved. <span className="dev-credit">� Website Designed for Prespecta Event @GyrFalcon Services</span>
          </div>
        </div>
      </div>
    </footer>
